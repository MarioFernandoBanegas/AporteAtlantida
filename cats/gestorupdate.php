...
<body oncontextmenu="return false" class="bg-dark">
  <div class="container">
    <div class="card card-register mx-auto mt-5">
      ...
      <?php
        extract($_GET);
        $sql="SELECT * FROM db_server WHERE Id_Dbserver=$id";
      ...
      ?>
        <form action="../updates/actualizar_gestor.php" method="post" enctype="multipart/form-data">
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-12">
                <label for="exampleInputName">ID_Gestor_B</label>
