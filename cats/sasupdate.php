...
<body oncontextmenu="return false" class="bg-dark">   
  <div class="container">
    <div class="card card-register mx-auto mt-5">
      ...
      <div class="card-header">Registro SAS</div>
      <div class="card-body">
      <?php
        extract($_GET);
        $sql="SELECT * FROM pci WHERE Id_SAS=$id";
      ...
      ?>
        <form action="../updates/actualizar_sas.php" method="post" enctype="multipart/form-data">
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-12">
                <label for="exampleInputName">ID_SAS</label>
                <input  style="text-align:center" readonly="readonly" value="<?php echo $id?>" type="text" class="form-control"  name="id">
              </div>
              <div class="col-md-12">
                <label for="exampleInputLastName">Nombre_SAS</label>
