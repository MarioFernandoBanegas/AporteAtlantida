<?php
   ...
   class Servidores
  {
    ...
    public function listado ( $conn ) {
      $sqla = ("SELECT s.IP, s.nombre, s.ul_fecha, r.Nombre_Responsable, o.Name_Zone, a.Name_Aplication 
        FROM SERVIDORES s 
        inner join CAT_SERVICIOS a on s.Id_Aplication = a.Id_Aplication 
        inner join responsable r on s.Id_Responsable = r.Id_Responsable
        inner join zone o on s.Id_Zone = o.Id_Zone");
      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Desglose">
          ...
          <ul class="sidenav-second-level collapse" id="collapseDesglose">
            <li><a href="details/prd.php">Producción</a></li>
            <li><a href="details/nub.php">Nube Privada</a></li>
            <li><a href="details/mon.php">Monitor</a></li>
            <li><a href="details/dev.php">Desarrollo / Calidad</a></li>
          </ul>
        </li>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Servers">
          ...
          <ul class="sidenav-second-level collapse" id="collapseComponents">
            ...
            <li><a href="ListaServidores.php">Listar Servidor</a></li>
      ...
      <div class="row">
        ...
        <div class="col-lg-2">
          <div class="card mb-3">
            ...
            <div class="card-body">
                <canvas id="BackupMON" width="50" height="50"></canvas>
            </div>
            <div class="card-footer">
            </div>
          </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-2">
          <div class="card mb-3">
            ...
            <div class="card-body">
                <canvas id="BackupDev" width="50" height="50"></canvas>
            </div>
            <div class="card-footer">
            </div>
          </div>
        ...
        <div class="card-header">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <?php
                if ( sqlsrv_num_rows( $listaServer ) > 0 ) {
              ?>
