<?php 
	...
	if($_SERVER['REQUEST_METHOD'] == 'POST')
	{
		...
		$data->bind_param('ssssssssssssssssss',$ip, $servidor, $estariesgo, $severiesgo, $protocolo, $puerto, $responsable, $aresponsable, $tipoa, $solucion, $descripcion, $paccion, $evidencias,$observaciones,$fechaec,$fechaecp,$numerop);
		$data->execute();
